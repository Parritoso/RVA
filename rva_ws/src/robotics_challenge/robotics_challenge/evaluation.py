...
class Evaluation(Node):
    def __init__(self):
        ...
        self.metrics = self.Metrics(self, self.output_file)
    ...
    class Metrics:
        def __init__(self,node, output_file):
        ...
        def store_metrics(self):
            ...
            self.node.get_logger().info("Stopped Evaluation node. Generating metrics result file")
            try:
    ...
    def scan_callback(self, data):
        ...
        if(m <= self.min_collision):
            ...
            self.get_logger().warn('Collision penalty!!!')
